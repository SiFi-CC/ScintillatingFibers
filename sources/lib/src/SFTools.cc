...
bool SFTools::CreateTable(TString database, TString table){
  ...
  if(table == "DATA"){
    ...
    query = "CREATE TABLE 'TEMPERATURE' ('SERIES_ID' INTEGER PRIMARY_KEY, 'RESULTS_FILE' TEXT, 'OUT_ID' TEXT, 'OUT_TEMP' NUMERIC, 'OUT_ERR' NUMERIC, 'REF_ID' TEXT, 'REF_TEMP' NUMERIC, 'REF_ERR' NUMERIC, 'CH0_ID' TEXT, 'CH0_TEMP' NUMERIC, 'CH0_ERR' NUMERIC, 'CH1_ID' TEXT, 'CH1_TEMP' NUMERIC, 'CH1_ERR' NUMERIC, 'DATE' INTIGER, PRIMARY KEY ('SERIES_ID'))";
  }
